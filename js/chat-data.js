...
const breads = [
    ...
    new bread("팡오레", "2,000원", "img/breads/팡오레.jpg",
        '찐한 옥수수향 가득 폭신한 [팡오레]<br> 스위트콘의 은은한 향이 가득한 팡오레. 작은 우박설탕 알갱이가 솔솔 뿌려진 고소한 옥수수빵. 찬 우유와 함께 드시면 최고! ※단체주문 추천빵',
        '당일섭취 권장상품', '직사광선을 피하고 서늘한 곳 보관', '10cm* 10cm',
        '밀, 우유, 난류(가금류) 함유/본 제품은 난류(가금류), 우유, 메밀, 아황산류, 대두, 토마토, 호두, 땅콩, 닭고기, 쇠고기, 밀, 새우, 돼지고기, 오징어, 잣을 사용한 제품과 같은 시설에서 제조하고 있습니다.', '강력(미국/캐나다) 계란(국산) 옥수수가루(옥수수:호주,인도,브라질 등) 스위트콘(태국)'
    ),
    new bread("초코튀소", "2,000원", "img/breads/초코튀소.jpg",
        '튀소 탄생 40주년을 기념하여 선보인 초코튀소는 달콤한 팥앙금을 가득 품은 바삭한 튀김소보로 위에 초콜릿 코팅을 입힌 완생의 빵 입니다.',
        '당일섭취 권장상품',
        '직사광선을 피하고 서늘한 곳 보관', '10cm* 10cm',
        '난류(가금류), 우유, 호두, 땅콩, 아몬드, 대두, 밀 함유/본 제품은 난류(가금류), 우유, 메밀, 아황산류, 대두, 토마토, 호두, 땅콩, 닭고기, 쇠고기, 밀, 새우, 돼지고기, 오징어, 잣을 사용한 제품과 같은 시설에서 제조하고 있습니다.'
        , '통팥앙금[팥(중국산),정제소금(국산)] 강력(미국/캐나다) 우유(원유:국산) 코팅초콜릿{가공유지[팜핵스테아린경화유(말레이시아), 코코아분말(싱가포르)]}'
    ),
    new bread("판타롱부추빵", "2,000원", "img/breads/판타롱부추빵.png",
        '푸릇푸릇 싱싱한 부추를 계란샐러드, 햄과 함께 직접 버무려 만든 부추향 가득 만두 같은 영양만점 판타롱 부추빵', '당일섭취 권장상품', '직사광선을 피하고 서늘한 곳 보관', '9cm * 12cm', '밀, 대두, 우유, 난류(가금류), 돼지, 닭고기, 쇠고기, 조개류(굴) 함유/본 제품은 난류(가금류), 우유, 메밀, 아황산류, 대두, 토마토, 호두, 땅콩, 닭고기, 쇠고기, 밀, 새우, 돼지고기, 오징어, 잣을 사용한 제품과 같은 시설에서 제조하고 있습니다.', '부추(국산) 강력(미국/캐나다) 계란(국산)'
    ),
    new bread("월넛브레드", "4,000원", "img/breads/월넛브레드.png",
        '견과류 가득 달콤꼬소한 [월넛브레드]<br> 씹을수록 꼬소한 호두를 가득 얹어 구운 빵. 한입 베어물면 바삭 달콤한 크런키와 오독오독 견과류가 입안 가득! 호두,완두콩,마카다미아,건포도 4가지의 견과류를 사용해서 담백하면서도 고소한 월넛브레드는 부담없이 모두가 좋아할만한 빵 이에요 ※단체주문 사이즈 변경 가능 제품'
        , '당일섭취 권장상품', '직사광선을 피하고 서늘한 곳 보관', '12cm * 17cm',
        '밀, 우유, 난류(가금류), 호두, 대두, 아황산류 함유/본 제품은 난류(가금류), 우유, 메밀, 아황산류, 대두, 토마토, 호두, 땅콩, 닭고기, 쇠고기, 밀, 새우, 돼지고기, 오징어, 잣을 사용한 제품과 같은 시설에서 제조하고 있습니다.', '강력(미국/캐나다) 호두(미국) 계란(백란:국산)'
    ),
    new bread("빅매치", "2,300원", "img/breads/빅매치.jpg",
        '바삭한 쿠키비스켓 토핑과 꾸덕한 크림치즈 [빅매치]<br> 한 입 베어물면, 바삭 달콤한 쿠키비스켓 토핑이 파사삭. 달달한 메이플 시럽을 믹스한 꾸덕한 크림치즈가 입안 가득 퍼질거에요. 차가운 바닐라 아이스크림을 얹어 따뜻한 커피와 함께 드시면 더욱 맛있는 달달꾸덕 빅매치 ※단체주문 추천빵'
        , '당일섭취 권장상품', '직사광선을 피하고 서늘한 곳 보관'
        , '10cm * 10cm',
        '밀, 우유, 난류(가금류), 땅콩, 아몬드, 호두 함유/본 제품은 난류(가금류), 우유, 메밀, 아황산류, 대두, 토마토, 호두, 땅콩, 닭고기, 쇠고기, 밀, 새우, 돼지고기, 오징어, 잣을 사용한 제품과 같은 시설에서 제조하고 있습니다.',
        '크림치즈(호주) 강력(미국/캐나다) 버터(뉴질랜드)'
    ),
    new bread("교황님의 치즈스콘", "4,000원", "img/breads/교황님의 치즈스콘.jpg",
        '2014년 8월, 교황님의 식탁에 오른 [치즈 스콘]<br> 고다치즈와 체다치즈 다이스를 듬뿍 넣어 깊고 찐한 치즈의 풍미가 남다른 리얼 치즈스콘입니다. 교황님이 한국 방문시 드셨던 간식으로 이후 더욱 유명해진 영광스러운 치즈스콘은 버터와 베리잼을 촉촉히 발라 찬 우유 또는 핫 커피와 함께 드시면 더욱 깊고 찐한 치즈의 풍미를 즐기실 수 있을거에요',
        '당일섭취 권장상품', '직사광선을 피하고 서늘한 곳 보관', '12cm * 11cm',
        '밀, 우유, 난류(가금류) 함유/본 제품은 난류(가금류), 우유, 메밀, 아황산류, 대두, 토마토, 호두, 땅콩, 닭고기, 쇠고기, 밀, 새우, 돼지고기, 오징어, 잣을 사용한 제품과 같은 시설에서 제조하고 있습니다.',
        '박력(미국) 버터(미국) 우유(국산) 고다다이스[자연치즈(독일산)] 체다다이스(미국)'
    ),
];
const brands = [
